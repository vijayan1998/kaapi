...
class WrongOTPScreen extends StatefulWidget {
  const WrongOTPScreen({super.key});

  @override
  State<WrongOTPScreen> createState() => _WrongOTPScreenState();
}

class _WrongOTPScreenState extends State<WrongOTPScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     ...
     child: Custombuttonwidget(text: 'Verify & Continue', 
         color:  Appcolors.appColors.shade200, textColor: Appcolors.appColors.shade100,
         onPressed: (){
            Get.toNamed(Appnames.otpverified);
         },),),
    );
  }
}